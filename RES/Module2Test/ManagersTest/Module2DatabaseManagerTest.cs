...
namespace Module2Test.ManagersTest
{
    ...
    public class Module2DatabaseManagerTest
    {
        ...
        /*We will comment out all code that accesses database. Since no viable answer was provided by teaching assistant as
         * to how database connection should be tested and SQL queries generated by C# classes, we will not delete this code for now. 
         * It should be noted that without these tests in place, we would have no way of knowing if this code actually does anything
         * to the database untill runtime and personal testing. Mocking database with a list, as suggested by teahcing assitant
         * DOES NOT solve this problem.
         * 
         * Initially database manager code was BROKEN, and without these test we would have no means of knowing that.
         */
